...
function FormPage() {
    ...
    return (
        <div className="flex justify-center items-center w-full bg-green-200">
            <div className="w-11/12 md:w-3/4 bg-gray-100 rounded-md shadow-2xl p-8 m-4">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="flex flex-col mb-4">
                        ...
                        <input {...register("donation")} className="border-2 rounded-md border-gray-200 py-2 px-3 pl-6 text-grey-800" min="1" type="number" />
                    ...
                    <div className="flex flex-col mb-4">
                        ...
                        <input {...register("email")} className="border-2 rounded-md border-gray-200 py-2 px-3 text-grey-800" type="email"/>
                    ...
                    <div className="flex flex-col mb-4">
                        ...
                        <input {...register("fullname")} className="border-2 rounded-md border-gray-200 py-2 px-3 text-grey-800" type="text" />
                    ...
                    <div className="flex flex-col mb-4">
                        ...
                        <input {...register("nric")} className="border-2 rounded-md border-gray-200 py-2 px-3 text-grey-800" type="text" />
                    ...
                    <div className="flex flex-col mb-4">
                        ...
                        <input {...register("phone_number")} className="border-2 rounded-md border-gray-200 py-2 px-3 text-grey-800" type="text" />
                    ...
                    <div className="flex flex-col mb-4">
                        ...
                        <textarea {...register("address")} className="border-2 rounded-md border-gray-200 py-2 px-3 text-grey-800" ></textarea>
                    ...
                    <div className="flex justify-end w-full mt-12">
                        <button className="bg-green-400 hover:bg-green-600 text-white uppercase text-lg px-10 py-2 rounded-lg" type="submit">Submit</button>
                    </div>
